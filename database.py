...
def filter_entrys():
    ...
    memoryDBCursor.execute("UPDATE prefix_as SET last_update = -1") #Set as inactive (withdrawn)
    ...
    memoryDBCursor.execute("UPDATE prefix_as SET last_update = 1 WHERE last_update != -1")
